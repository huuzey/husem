  ...
  return (
    <div className="flex flex-col w-full items-stretch justify-evenly mr-3 gap-2 ">
      ...
      <button
        ...
        }   text-white border-2 w-3/4  sm:px-1 md:px-0 flex items-center  justify-center text-[6px] md:text-[6px] sm:font-light md:font-semibold py-1 border-black bg-[#32a8a4]   rounded-full`}
      >
        {title}
      </button>
    </div>
